...
### Load functions
source("./Manuscript/Codes/pop_cod_fn.R")
...
save(survey_cod, file = "./Manuscript/Data/survey_cod_base.Rdata")
...
save(setdet_cod, file = "./Manuscript/Data/setdet_cod_base.Rdata")
...
save(index_cod_all_scenarios, file = "./Manuscript/Data/index_cod_all_scenarios.Rdata")
