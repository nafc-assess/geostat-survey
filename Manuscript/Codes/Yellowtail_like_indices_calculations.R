...
### Load functions
source("./Manuscript/Codes/pop_yellowtail_fn.R")
source("./Manuscript/Codes/model_run_fn.R")
source("./Manuscript/Codes/bootstrapping_fn.R")
...
save(survey_yellowtail, file = "./Manuscript/Data/survey_yellowtail_base.Rdata")
...
save(setdet_yellowtail, file = "./Manuscript/Data/setdet_yellowtail_base.Rdata")
...
sdm_TW_IID_index_yellowtail <- furrr::future_map2_dfr(sdm_data_yellowtail, mesh_sdm_yellowtail,
                                                      formula = formula3, range_gt = 125, sigma_lt = 12.5, type = "TW", scenario = "Base",
...
sdm_TW_IID_depth_index_yellowtail <- furrr::future_map2_dfr(sdm_data_yellowtail, mesh_sdm_yellowtail,
                                                            formula = formula4, range_gt = 125, sigma_lt = 12.5, type = "TW + Depth", scenario = "Base",
                                                            species = "Yellowtail-like", newdata = sdm_newdata_yellowtail, model_run_TW, .id = "model", .progress = TRUE)
### IID + DG
...
sdm_TW_IID_index_yellowtail_r30 <- furrr::future_map2_dfr(sdm_data_yellowtail_r30, mesh_sdm_yellowtail_r30,
                                                      formula = formula3, range_gt = 125, sigma_lt = 12.5, type = "TW", scenario = "30% set reduction",
                                                      species = "Yellowtail-like", newdata = sdm_newdata_yellowtail, model_run_TW, .id = "model", .progress = TRUE)
### IID + TW + depth
sdm_TW_IID_depth_index_yellowtail_r30 <- furrr::future_map2_dfr(sdm_data_yellowtail_r30, mesh_sdm_yellowtail_r30,
                                                            formula = formula4, range_gt = 125, sigma_lt = 12.5, type = "TW + Depth", scenario = "30% set reduction",
                                                            species = "Yellowtail-like", newdata = sdm_newdata_yellowtail, model_run_TW, .id = "model", .progress = TRUE)
### IID + DG
...
sdm_TW_IID_index_yellowtail_b30 <- furrr::future_map2_dfr(sdm_data_yellowtail_b30, mesh_sdm_yellowtail_b30,
                                                      formula = formula3, range_gt = 125, sigma_lt = 12.5, type = "TW", scenario = "30% area blocked",
                                                      species = "Yellowtail-like", newdata = sdm_newdata_yellowtail, model_run_TW, .id = "model", .progress = TRUE)
### IID + TW + depth
sdm_TW_IID_depth_index_yellowtail_b30 <- furrr::future_map2_dfr(sdm_data_yellowtail_b30, mesh_sdm_yellowtail_b30,
                                                            formula = formula4, range_gt = 125, sigma_lt = 12.5, type = "TW + Depth", scenario = "30% area blocked",
                                                            species = "Yellowtail-like", newdata = sdm_newdata_yellowtail, model_run_TW, .id = "model", .progress = TRUE)
### IID + DG
...
sdm_TW_IID_index_yellowtail_SR  <- furrr::future_map2_dfr(sdm_data_yellowtail_SR, mesh_sdm_yellowtail_SR,
                                                      formula = formula3, range_gt = 125, sigma_lt = 12.5, type = "TW", scenario = "Strata removal",
                                                      species = "Yellowtail-like", newdata = sdm_newdata_yellowtail, model_run_TW, .id = "model", .progress = TRUE)
### IID + TW + depth

sdm_TW_IID_depth_index_yellowtail_SR  <- furrr::future_map2_dfr(sdm_data_yellowtail_SR, mesh_sdm_yellowtail_SR,
                                                            formula = formula4, range_gt = 125, sigma_lt = 12.5, type = "TW + Depth", scenario = "Strata removal",
                                                            species = "Yellowtail-like", newdata = sdm_newdata_yellowtail, model_run_TW, .id = "model", .progress = TRUE)
### IID + DG
...
save(index_yellowtail_all_scenarios, file = "./Manuscript/Data/index_yellowtail_all_scenarios.Rdata")
