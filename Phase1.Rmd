...
To create a DHARMa object, we need a matrix simulations from the fitted model, true observations, and fitted predicted response.
...
fit_dharma <- DHARMa::createDHARMa(
  ...
  fittedPredictedResponse = fit$family$linkinv(predict(fit)$est) #fitted predicted response
)
