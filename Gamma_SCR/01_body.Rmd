...
Provided these values, density and quantile functions for the Gamma distribution can be used to calculate probabilities.For instance, the probability that the index increased from one year to the next can be quantified.
